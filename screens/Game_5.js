...
const Game_5 = () => {
  ...
  const [circles, setCircles] = useState(Array(36).fill(false));
  const [score, setScore] = useState(0);
  const [gameStarted, setGameStarted] = useState(false);
  const [timer, setTimer] = useState(5);
  const [clickedCircles, setClickedCircles] = useState(Array(36).fill(false));
      ...
      [
        ...
        },
        {
          ...
          onPress: async () => {
            ...
            navigation.replace("NormalResult");
          },
        },
      ],
      { cancelable: false }
  ...
  const startGame = () => {
    setGameStarted(true);
    setCircles(Array(36).fill(false));
    setScore(0);
    lightUpRandomCircle();
  };
